            ...
            "aoColumns": [{
                ...
                },
                {
                    "render": function (data, type, row) {
                        return '<div class="text-center"> <a href="' + row.path + '" data-id="' + row.id + '" class="btn btn-info btn-sm ml-2 "> <span> Télécharger <i class="la la-download"></i></span></a>  <a data-id="' + row.id + '" href="#' + row.id + '" class="btn btn-danger btn-sm ml-2 deleteFile"> <span> <i class="la la-trash"></i> </span> </a>   </div>';
                    }
                },
            ]
        })
